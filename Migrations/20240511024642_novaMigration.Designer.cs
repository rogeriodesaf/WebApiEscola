...
namespace APIEscola.Migrations
{
    ...
    [Migration("20240511024642_novaMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("APIEscola.Models.Disciplinas.DisciplinaModel", b =>
                {
                    ...
                    b.Property<int?>("ProfessoresModelId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("ProfessoresModelId");
            ...
            modelBuilder.Entity("APIEscola.Models.Disciplinas.DisciplinaModel", b =>
                {
                    b.HasOne("APIEscola.Models.Professores.ProfessoresModel", null)
                        .WithMany("Disciplina")
                        .HasForeignKey("ProfessoresModelId");
                });
